...
function(){
    if(document.visibilityState === "visible"){
        document.title = "Portfolio | Harsh Gupta";
...
// <!-- typed js effect starts -->
    var typed = new Typed(".typing-text", {
        strings: ["Full-Stack developer", "DSA Enthusiast"],
        loop: true,
        typeSpeed: 50,
		backSpeed: 25,
		backDelay: 500,
...
// End of Tawk.to Live Chat
 ...
 $("#contact-form").submit(function (event) {
    ...
    event.preventDefault();
    emailjs.init("26OcjS5TKLdme2hBd");
    console.log("form submitted");
    emailjs.sendForm('service_t0pnwtq', 'template_38o3wfr', '#contact-form')
